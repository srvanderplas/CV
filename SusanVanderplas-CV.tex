...
\cvitem{In Progress}{
    ...
    \item [Testing Statistical Charts: What makes a good graph?] A review of research relating to the testing of statistical graphics across different domains and disciplines. Submitted to Annual Reviews, Accepted August 2019.
    ...
    \item [Bullet Test Set Validation] Validate an algorithm for bullet matching on several test sets used to test forensic examiner proficiency. Submitted to Forensic Science International, August 2019.
