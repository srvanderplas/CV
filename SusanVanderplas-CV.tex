...
\cvitem{In Progress}{
    ...
    \item [Generalized Parallel Coordinate Plots: ggpcp] with Heike Hofmann and Antony Unwin. An R package for creation of generalized parallel coordinate plots. Submitted to JCGS, November 2022.
